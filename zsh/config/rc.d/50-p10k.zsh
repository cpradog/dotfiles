...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    vcs                       # git status
    pairing                   # show pairing information
    # =========================[ Line #2 ]=========================
    newline                   # \n
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    haskell_stack             # haskell vesion from stack
  )
  ...
  #
  # Grey haskell stack Environment.
  typeset -g POWERLEVEL9K_HASKELL_STACK_FOREGROUND=$white
  ...
  # Don't show git and git remote icon
